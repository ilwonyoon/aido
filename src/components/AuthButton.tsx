...
export function AuthButton() {
  ...
  return (
    <div className="relative group/auth">
      ...
      {/* Tooltip */}
      <div className="absolute right-0 top-full mt-2 w-64 p-3 bg-[var(--card)] border border-[var(--border)] rounded-lg shadow-lg opacity-0 invisible group-hover/auth:opacity-100 group-hover/auth:visible transition-all z-50 text-left pointer-events-none">
        <div className="text-xs text-[var(--muted)] space-y-2">
          <p>
            Track companies you're interested in and get notified about updates.
          </p>
          <p className="text-[var(--muted)] opacity-75">
