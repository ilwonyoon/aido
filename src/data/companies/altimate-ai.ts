...
export const altimateAi: Company = {
  id: 'altimate-ai',
  name: 'Altimate AI',
  description: 'Altimate AI builds AI-native workflow software for modern teams.',
  website: 'https://www.altimate.ai',
  headquarters: 'San Francisco, CA',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/altimate-ai-og.webp',
  ...
  sources: [
    { title: 'Altimate AI website', url: 'https://www.altimate.ai' },
    { title: 'Altimate AI Wellfound profile', url: 'https://wellfound.com/company/altimate-ai' },
    { title: 'Altimate AI Crunchbase profile', url: 'https://www.crunchbase.com/organization/altimate-ai' },
  ],
};
