...
export const imbueAi: Company = {
  ...
  // Visual Assets
  ogImage: 'https://imbue.com/sculptor/og-image.png',
  screenshot: '/screenshots/imbue-ai-screenshot.png',
  ...
  marketPosition: 'Rekindling the dream of personal computing',
  moat: ['Unknown'],
  vsGiants: 'Unknown',
