...
export const faction: Company = {
  id: 'faction',
  name: 'Faction',
  description: 'Faction builds AI-native workflow software for modern teams.',
  website: 'https://www.usefaction.com',
  headquarters: 'San Francisco, CA',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/faction-og.webp',
  ...
  sources: [
    { title: 'Faction website', url: 'https://www.usefaction.com' },
    { title: 'Faction Wellfound profile', url: 'https://wellfound.com/company/faction' },
    { title: 'Faction Crunchbase profile', url: 'https://www.crunchbase.com/organization/faction' },
  ],
};
