...
export const abacusAi: Company = {
  id: 'abacus-ai',
  name: 'Abacus.AI',
  description: 'Abacus.AI builds AI-native workflow software for modern teams.',
  website: 'https://abacus.ai',
  headquarters: 'San Francisco, CA',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/abacus-ai-og.webp',
  ...
  sources: [
    { title: 'Abacus.AI website', url: 'https://abacus.ai' },
    { title: 'Abacus.AI Wellfound profile', url: 'https://wellfound.com/company/abacus-ai' },
    { title: 'Abacus.AI Crunchbase profile', url: 'https://www.crunchbase.com/organization/abacus-ai' },
  ],
};
