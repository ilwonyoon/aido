...
export const divineResearch: Company = {
  id: 'divine-research',
  name: 'Divine',
  description: 'Undercollateralized lending system.',
  website: 'https://startups.gallery/companies/divine-research',
  ...
  marketPosition: 'Undercollateralized lending system',
  moat: ['Unknown'],
  vsGiants: 'Unknown',
