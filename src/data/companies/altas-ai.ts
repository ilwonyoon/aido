...
export const altasAi: Company = {
  id: 'altas-ai',
  name: 'Altas AI',
  description: 'Altas AI builds AI-native workflow software for modern teams.',
  website: 'https://www.altasai.co',
  headquarters: 'San Francisco, CA',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/altas-ai-og.webp',
  ...
  sources: [
    { title: 'Altas AI website', url: 'https://www.altasai.co' },
    { title: 'Altas AI Wellfound profile', url: 'https://wellfound.com/company/altas-ai' },
    { title: 'Altas AI Crunchbase profile', url: 'https://www.crunchbase.com/organization/altas-ai' },
  ],
};
