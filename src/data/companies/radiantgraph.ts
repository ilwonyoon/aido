...
export const radiantgraph: Company = {
  id: 'radiantgraph',
  name: 'Radiantgraph',
  description: 'Intelligent personalization for healthcare.',
  website: 'https://radiantgraph.com',
  ...
  marketPosition: 'Intelligent personalization for healthcare',
  moat: ['Unknown'],
  vsGiants: 'Unknown',
