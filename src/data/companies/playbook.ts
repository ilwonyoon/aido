...
export const playbook: Company = {
  id: 'playbook',
  name: 'Playbook',
  description: 'Cloud storage for creatives.',
  website: 'https://www.playbook.com',
  ...
  marketPosition: 'Cloud storage for creatives',
  moat: ['Unknown'],
  vsGiants: 'Unknown',
  ...
  sources: [
    { title: 'Source', url: 'https://www.playbook.com' },
    { title: 'Source', url: 'https://startups.gallery/companies/playbook' }
  ],
};
