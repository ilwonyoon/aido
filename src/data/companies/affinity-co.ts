...
export const affinityCo: Company = {
  id: 'affinity-co',
  name: 'Affinity',
  description: 'Relationship intelligence CRM for deal teams and business development workflows.',
  website: 'https://affinity.co',
  headquarters: 'San Francisco, CA',
  remote: 'Hybrid',

    // OG Image
    ogImage: '/og-images/affinity-co-og.webp',
  ...
  valuation: 'Private company; valuation references differ by source and financing date.',
  totalFunding: 'Public databases report multiple rounds of financing.',
  ...
  sources: [
    { title: 'Affinity website', url: 'https://affinity.co' },
    { title: 'Affinity Wellfound profile', url: 'https://wellfound.com/company/affinity-co' },
    { title: 'Affinity Crunchbase profile', url: 'https://www.crunchbase.com/organization/affinity-co' },
  ],
};
