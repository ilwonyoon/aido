...
export const dimensionLabs: Company = {
  id: 'dimension-labs',
  name: 'Dimension Labs',
  description: 'Labs Unstructured conversation analytics platform.',
  website: 'https://dimension.ai',
  ...
  marketPosition: 'Labs Unstructured conversation analytics platform',
  moat: ['Unknown'],
  vsGiants: 'Unknown',
