...
export const gong: Company = {
  ...
  industries: ['infrastructure', 'sales-marketing'],
    ...
    competitors: [],
    marketPosition: 'Leading revenue intelligence platform. Pioneer in conversation intelligence with 4,000+ enterprise customers and $332M+ ARR.',
    moat: [],
    aiNativeLevel: 'B',
    ...
    founders: [
      {
        name: 'Amit Bendov',
        role: 'Co-founder & CEO',
        background: 'BSc Computer Science from Tel Aviv University. 20+ years in enterprise software. Former CEO of SiSense (analytics), CMO of Panaya. Experienced the problem of incomplete customer data firsthand as a sales executive.',
      },
      {
        name: 'Eilon Reshef',
        role: 'Co-founder & CPO',
        background: 'Seasoned entrepreneur, executive, and investor in internet and software. Previously co-founded Webcollage. Data scientist background. Longtime friend of Amit Bendov.',
      },
    ],
    whyBuilding: 'Amit Bendov experienced firsthand the problem of incomplete customer and prospect information as a sales executive. He partnered with Eilon Reshef to use AI to understand what customers were actually saying in conversations.',
    beliefs: [],
