...
export const elevenlabs: Company = {
  ...
  name: 'ElevenLabs',
  description:
    'AI audio platform for speech generation, voice agents, dubbing, and developer APIs.',
  ...
  fundingHistory: [
    {
      ...
      amount: '$2M',
      date: '2023-01',
      leadInvestors: ['Credo Ventures'],
    },
    {
      stage: 'Series A',
      amount: '$19M',
      date: '2023-06',
      leadInvestors: ['Nat Friedman', 'Daniel Gross'],
    },
    {
      stage: 'Series B',
      amount: '$80M',
  ...
  runway: 'Strong',
  customers:
    'Millions of users; enterprise customers include Deutsche Telekom, Square, Meta, and Revolut',
  ...
  competitors: [
    {
      ...
      whyTheyWin:
        'AWS distribution, enterprise integrations, pay-as-you-go pricing at scale',
    },
    {
  ...
  vsGiants:
    'Quality differentiation — ElevenLabs voices are noticeably more natural than AWS/Google. Specialized focus vs generic cloud services. Voice cloning capability that cloud giants avoid due to liability concerns.',

  aiNativeLevel: 'A',
  aiNativeLevelDescription:
    'AI-Native/Zero-to-One: AI IS the product. Creating human-quality AI voice synthesis from scratch. Defining voice AI category.',
  aiDesignChallenges: [
  ...
  targetAudiences: {
    primary:
      'Publishers, audiobook producers, and content creators needing voice-over',
    secondary:
      'Game studios, filmmakers, and developers building voice-enabled applications',
  },
  userProblems: [
  ...
  designerLinks: [
    {
      ...
      description:
        'Design collaborator referenced in the official Product Designer job posting',
    },
    {
      name: 'Austin Malerba',
      role: 'Design',
      platform: 'twitter',
      url: 'https://x.com/austin_malerba?lang=en',
      description:
        'Design collaborator referenced in the official Product Designer job posting',
    },
    {
  ...
  cultureInsights: [
    {
      ...
      rating: 4.2,
      content:
        'Fast growth, ambitious team. Remote-friendly. Polish engineering excellence.',
    ...
    },
    {
      ...
      sentiment: 'neutral',
      content:
        'Scaling pains as company grows (~100 people). Good comp, high expectations. Limited design team culture info.',
    },
    {
      source: 'linkedin',
      sentiment: 'positive',
      content:
        'European distributed team (Poland, UK, US). Engineering-centric culture.',
    },
    {
      source: 'levels.fyi',
      sentiment: 'neutral',
      content:
        'No Product Design data. SWE reference: Senior $200-300K estimated (Remote).',
  ...
  growthMetrics: {
    ...
    ceiling:
      'Mid-innings: Voice cloning is proven, but enterprise adoption (gaming, audiobooks, ads) is early. Market expanding as quality improves.',
    tailwinds: [
    ...
    moatType: 'technology',
    moatStrength:
      'Medium: Best-in-class voice quality and emotional range creates technical moat. Voice library and cloning tech have some switching costs. No strong network effects, but brand in voice AI is growing.',
  },
  ...
  sources: [
    { title: 'ElevenLabs About', url: 'https://elevenlabs.io/about' },
    {
      title: 'ElevenLabs Series D Announcement',
      url: 'https://elevenlabs.io/blog/series-d',
    },
    {
      title: 'TechCrunch - ElevenLabs raises $500M at $11B valuation',
    ...
    {
      title: 'ElevenLabs Product Designer role',
      url: 'https://elevenlabs.io/careers/89da00ec-11b0-4359-913b-c3a89c1013bc/product-designer',
    },
    {
      title: 'LinkedIn - ElevenLabs company page',
      url: 'https://www.linkedin.com/company/elevenlabsio/',
    },
    {
      title: 'LinkedIn Jobs - ElevenLabs',
      url: 'https://www.linkedin.com/company/elevenlabsio/jobs',
    },
  ],
};
