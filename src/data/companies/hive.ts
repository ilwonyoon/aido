...
export const hive: Company = {
  id: 'hive',
  name: 'Hive',
  description: 'AI cloud platform for content moderation, search, and enterprise model APIs.',
  website: 'https://thehive.ai',
  headquarters: 'San Francisco, CA',
  remote: 'Hybrid',

    // Screenshot fallback
    screenshot: '/og-images/hive-screenshot.webp',

  aiTypes: ['ai-infrastructure','data-analysis'],
  markets: ['b2b','enterprise'],
  industries: ['security'],

  stage: 'Growth-stage private',
  valuation: 'Private company; valuation references vary by publication period.',
  totalFunding: 'Public databases report venture-backed financing.',
  ...
  sources: [
    { title: 'Hive website', url: 'https://thehive.ai' },
    { title: 'Hive Wellfound profile', url: 'https://wellfound.com/company/hive' },
    { title: 'Hive Crunchbase profile', url: 'https://www.crunchbase.com/organization/hive' },
  ],
};
