...
export const humanBehavior: Company = {
  id: 'human-behavior',
  name: 'Human Behavior',
  description: 'Behavior Behavioral analytics platform.',
  website: 'https://humanbehavior.ai',
  ...
  marketPosition: 'Behavior Behavioral analytics platform',
  moat: ['Unknown'],
  vsGiants: 'Unknown',
