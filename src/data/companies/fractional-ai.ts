...
export const fractionalAi: Company = {
  id: 'fractional-ai',
  name: 'Fractional AI',
  description: 'Fractional AI builds AI-native workflow software for modern teams.',
  website: 'https://www.fractional.ai',
  headquarters: 'San Francisco, CA',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/fractional-ai-og.webp',
  ...
  sources: [
    { title: 'Fractional AI website', url: 'https://www.fractional.ai' },
    { title: 'Fractional AI Wellfound profile', url: 'https://wellfound.com/company/fractional-ai' },
    { title: 'Fractional AI Crunchbase profile', url: 'https://www.crunchbase.com/organization/fractional-ai' },
  ],
};
