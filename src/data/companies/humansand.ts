...
export const humansand: Company = {
  ...
  industries: ['other'],
    ...
    sources: [
    { title: 'Source', url: 'https://startups.gallery/companies/humansand' },
    { title: 'Source', url: 'https://techcrunch.com/2026/01/20/openai-alums-raise-480m-seed-round-for-humans-ai/' },
    { title: 'Source', url: 'https://humansand.ai/' },
    { title: 'Source', url: 'https://jobs.ashbyhq.com/humans-and' }
  ],
  };
