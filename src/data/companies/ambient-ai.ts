...
export const ambientAi: Company = {
  id: 'ambient-ai',
  name: 'Ambient.ai',
  description: 'AI-powered physical security platform with computer vision for threat detection and response.',
  website: 'https://ambient.ai',
  headquarters: 'San Francisco, CA',
  remote: 'Hybrid',

    // OG Image
    ogImage: '/og-images/ambient-ai-og.webp',
  ...
  valuation: 'Private company; valuation not consistently disclosed in recent public reporting.',
  totalFunding: 'Public databases list venture funding rounds and investors.',
  ...
  sources: [
    { title: 'Ambient.ai website', url: 'https://ambient.ai' },
    { title: 'Ambient.ai Wellfound profile', url: 'https://wellfound.com/company/ambient-ai' },
    { title: 'Ambient.ai Crunchbase profile', url: 'https://www.crunchbase.com/organization/ambient-ai' },
  ],
};
