...
export const afresh: Company = {
  id: 'afresh',
  name: 'Afresh',
  description: 'AI-assisted retail operations platform optimizing fresh inventory planning and supply decisions.',
  website: 'https://afresh.com',
  headquarters: 'San Francisco, CA',
  remote: 'Hybrid',

    // OG Image
    ogImage: '/og-images/afresh-og.webp',
  ...
  sources: [
    { title: 'Afresh website', url: 'https://afresh.com' },
    { title: 'Afresh Wellfound profile', url: 'https://wellfound.com/company/afresh' },
    { title: 'Afresh Crunchbase profile', url: 'https://www.crunchbase.com/organization/afresh' },
  ],
};
