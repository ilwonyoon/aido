...
export const evvolveAndPartners: Company = {
  id: 'evvolve-and-partners',
  name: 'Evvolve & Partners',
  description: 'Evvolve & Partners builds AI-native workflow software for modern teams.',
  website: 'https://www.evvolve.io',
  headquarters: 'United States',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/evvolve-and-partners-og.webp',
  ...
  sources: [
    { title: 'Evvolve & Partners website', url: 'https://www.evvolve.io' },
    { title: 'Evvolve & Partners Wellfound profile', url: 'https://wellfound.com/company/evvolve-and-partners' },
    { title: 'Evvolve & Partners Crunchbase profile', url: 'https://www.crunchbase.com/organization/evvolve-and-partners' },
  ],
};
