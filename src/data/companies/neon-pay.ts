...
export const neonPay: Company = {
  id: 'neon-pay',
  name: 'Neon Pay',
  description: 'Pay Commerce and payment tools for games.',
  website: 'https://startups.gallery/companies/neon-pay',
  ...
  marketPosition: 'Pay Commerce and payment tools for games',
  moat: ['Unknown'],
  vsGiants: 'Unknown',
