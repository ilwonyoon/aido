...
export const floeLabs: Company = {
  id: 'floe-labs',
  name: 'Floe Labs',
  description: 'AI-native lab and model operations startup building tooling for accelerated experimentation cycles.',
  website: 'https://floelabs.xyz',
  headquarters: 'San Francisco, CA',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/floe-labs-og.webp',
  ...
  lastUpdated: '2026-02-03T09:35:39',
  sources: [
    { title: 'Floe Labs website', url: 'https://floelabs.xyz' },
    { title: 'Floe Labs Wellfound profile', url: 'https://wellfound.com/company/floe-labs' },
    { title: 'Floe Labs Crunchbase profile', url: 'https://www.crunchbase.com/organization/floe-labs' },
  ],
};
