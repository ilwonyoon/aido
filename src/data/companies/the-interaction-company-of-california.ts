...
export const theInteractionCompanyOfCalifornia: Company = {
  id: 'the-interaction-company-of-california',
  name: 'The Interaction Company Of California',
  description: 'Interaction Company of California Building Poke.',
  ...
  marketPosition: 'Interaction Company of California Building Poke',
  moat: ['Unknown'],
  vsGiants: 'Unknown',
