  ...
  openRoles: [
    {
      ...
      team: 'AI Powered Workflows',
      level: 'Staff',
      type: 'full-time',
      compensation: '$265,000 + equity',
      responsibilities: [
        'Lead design and execution of AI-centric workflow builder for compliance automation',
        'Conduct customer research and create supporting narratives',
        'Mentor designers and strengthen the design function',
      ],
      requirements: [
        '8-10+ years B2B SaaS product delivery at scale',
        'Independent in discovery and strategy translation',
        'Portfolio showing consumer-grade craftsmanship',
      ],
      whyInteresting: 'Defining the AI agent interaction model for compliance — rare 0→1 AI workflow design at staff level',
    },
    {
      title: 'Staff Product Designer, GRC',
      location: 'Remote (US)',
      url: 'https://jobs.ashbyhq.com/vanta/3c9e7e35-1a93-4a36-8db9-48aee332ca57',
      team: 'GRC',
      level: 'Staff',
      type: 'full-time',
      compensation: '$225,000-$265,000 + equity',
      responsibilities: [
        'Lead design vision and execution for GRC pillar',
        'Drive end-to-end design from concept to post-launch',
        'Champion org-wide design-driven initiatives',
      ],
      requirements: [
        '8-10+ years in B2B SaaS',
        'Strong discovery and research skills',
        'GRC/cybersecurity domain experience preferred',
      ],
      whyInteresting: 'Owning design for the core compliance product at the category leader',
    },
    {
      title: 'Staff Product Designer, Platform',
      location: 'Remote (US)',
      url: 'https://jobs.ashbyhq.com/vanta/2c5defaf-1673-4206-8235-fbe721e8e7d2',
    ...
    },
    {
      ...
      location: 'Remote (US)',
      url: 'https://jobs.ashbyhq.com/vanta/8de8cbab-e3b7-46c2-92b4-0dbcc234a8dc',
      team: 'GRC Ops',
      level: 'Senior',
      type: 'full-time',
      compensation: '$183,000-$215,000 + equity',
      responsibilities: [
        'Design intuitive UX for complex compliance workflows (SOC 2, HIPAA, GDPR)',
        'Develop user understanding and iterate based on research and data',
        'Develop AI-first compliance features',
      ],
      requirements: [
        '6+ years product design experience',
        'Strong Figma proficiency',
        'Accessible and inclusive design experience',
      ],
      whyInteresting: 'Hands-on compliance UX work with AI integration at senior level',
    },
    {
      title: 'Senior Product Designer, Vendor Risk Management',
      location: 'Remote (US)',
      url: 'https://jobs.ashbyhq.com/vanta/c2b2518d-071c-4ac1-be6b-02ff690a92fb',
      team: 'Vendor Risk Management',
      level: 'Senior',
      type: 'full-time',
      compensation: '$167,000-$196,000 + equity',
    },
    {
      title: 'Senior Product Designer, Product Platform',
      location: 'Remote (US)',
      url: 'https://jobs.ashbyhq.com/vanta/ca9fe540-ced6-4409-84f0-c354aab6f8f8',
      team: 'Product Platform',
      level: 'Senior',
      type: 'full-time',
      compensation: '$150,000-$170,000 + equity',
    },
    {
      title: 'Senior Product Designer, Personnel & Access Management',
      location: 'Remote (US)',
      url: 'https://jobs.ashbyhq.com/vanta/987d7bce-4049-4695-b47a-de096aaea24f',
      team: 'Personnel & Access Management',
      level: 'Senior',
      type: 'full-time',
      compensation: '$167,000-$196,000 + equity',
    },
