...
export const promisePay: Company = {
  id: 'promise-pay',
  name: 'Promise',
  description: 'Streamlining government payments and benefits.',
  website: 'https://www.promise.com',
  ...
  marketPosition: 'Streamlining government payments and benefits',
  moat: ['Unknown'],
  vsGiants: 'Unknown',
