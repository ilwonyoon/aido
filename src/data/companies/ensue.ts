...
export const ensue: Company = {
  id: 'ensue',
  name: 'ensue',
  description: 'ensue builds AI-powered developer workflows and infrastructure tooling.',
  website: 'https://ensue.dev/readme',
  headquarters: 'San Francisco, CA',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/ensue-og.webp',
  ...
  sources: [
    { title: 'ensue website', url: 'https://ensue.dev/readme' },
    { title: 'ensue Wellfound profile', url: 'https://wellfound.com/company/ensue' },
    { title: 'ensue Crunchbase profile', url: 'https://www.crunchbase.com/organization/ensue' },
  ],
};
