...
export const hiveai: Company = {
  id: 'hiveai',
  name: 'Hiveai',
  description: 'Hiveai builds AI-native workflow software for modern teams.',
  website: 'https://wellfound.com/company/hiveai',
  headquarters: 'San Francisco, CA',
  remote: 'No',

    // Screenshot fallback
    screenshot: '/og-images/hiveai-screenshot.webp',
  ...
  sources: [
    { title: 'Hiveai website', url: 'https://wellfound.com/company/hiveai' },
    { title: 'Hiveai Wellfound profile', url: 'https://wellfound.com/company/hiveai' },
    { title: 'Hiveai Crunchbase profile', url: 'https://www.crunchbase.com/organization/hiveai' },
  ],
};
