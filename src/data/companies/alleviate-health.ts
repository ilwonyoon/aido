...
export const alleviateHealth: Company = {
  id: 'alleviate-health',
  name: 'Alleviate Health',
  description: 'Alleviate Health builds AI-native healthcare workflows and clinical productivity tools.',
  website: 'https://alleviatehealth.care',
  headquarters: 'San Francisco, CA',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/alleviate-health-og.webp',
  ...
  sources: [
    { title: 'Alleviate Health website', url: 'https://alleviatehealth.care' },
    { title: 'Alleviate Health Wellfound profile', url: 'https://wellfound.com/company/alleviate-health' },
    { title: 'Alleviate Health Crunchbase profile', url: 'https://www.crunchbase.com/organization/alleviate-health' },
  ],
};
