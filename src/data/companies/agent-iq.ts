...
export const agentIq: Company = {
  id: 'agent-iq',
  name: 'Agent IQ',
  description: 'Agent IQ builds AI-native workflow software for modern teams.',
  website: 'https://agentiq.com',
  headquarters: 'San Francisco, CA',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/agent-iq-og.webp',
  ...
  sources: [
    { title: 'Agent IQ website', url: 'https://agentiq.com' },
    { title: 'Agent IQ Wellfound profile', url: 'https://wellfound.com/company/agent-iq' },
    { title: 'Agent IQ Crunchbase profile', url: 'https://www.crunchbase.com/organization/agent-iq' },
  ],
};
