...
export const goodgoblinAi: Company = {
  id: 'goodgoblin-ai',
  name: 'GoodGoblin.ai',
  description: 'GoodGoblin.ai builds AI-native workflow software for modern teams.',
  website: 'https://www.goodgoblin.ai',
  headquarters: 'San Jose',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/goodgoblin-ai-og.webp',
  ...
  sources: [
    { title: 'GoodGoblin.ai website', url: 'https://www.goodgoblin.ai' },
    { title: 'GoodGoblin.ai Wellfound profile', url: 'https://wellfound.com/company/goodgoblin-ai' },
    { title: 'GoodGoblin.ai Crunchbase profile', url: 'https://www.crunchbase.com/organization/goodgoblin-ai' },
  ],
};
