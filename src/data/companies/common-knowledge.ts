...
export const commonKnowledge: Company = {
  id: 'common-knowledge',
  name: 'Common Knowledge',
  description: 'Knowledge Reinventing the document in the age of AI.',
  website: 'https://commonknowledge.ai',
  ...
  marketPosition: 'Knowledge Reinventing the document in the age of AI',
  moat: ['Unknown'],
  vsGiants: 'Unknown',
