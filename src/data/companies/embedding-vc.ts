...
export const embeddingVc: Company = {
  id: 'embedding-vc',
  name: 'Embedding VC',
  description: 'Embedding VC builds AI-native workflow software for modern teams.',
  website: 'https://embedding.vc',
  headquarters: 'Palo Alto',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/embedding-vc-og.webp',
  ...
  sources: [
    { title: 'Embedding VC website', url: 'https://embedding.vc' },
    { title: 'Embedding VC Wellfound profile', url: 'https://wellfound.com/company/embedding-vc' },
    { title: 'Embedding VC Crunchbase profile', url: 'https://www.crunchbase.com/organization/embedding-vc' },
  ],
};
