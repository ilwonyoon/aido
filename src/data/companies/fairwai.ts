...
export const fairwai: Company = {
  id: 'fairwai',
  name: 'FairwAI',
  description: 'FairwAI builds AI-native workflow software for modern teams.',
  website: 'https://gofairwai.com',
  headquarters: 'San Francisco, CA',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/fairwai-og.webp',
  ...
  sources: [
    { title: 'FairwAI website', url: 'https://gofairwai.com' },
    { title: 'FairwAI Wellfound profile', url: 'https://wellfound.com/company/fairwai' },
    { title: 'FairwAI Crunchbase profile', url: 'https://www.crunchbase.com/organization/fairwai' },
  ],
};
