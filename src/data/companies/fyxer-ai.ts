...
export const fyxerAi: Company = {
  id: 'fyxer-ai',
  name: 'Fyxer AI',
  description: 'Fyxer AI builds AI-native workflow software for modern teams.',
  website: 'https://www.fyxer.com',
  headquarters: 'San Francisco, CA',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/fyxer-ai-og.webp',
  ...
  sources: [
    { title: 'Fyxer AI website', url: 'https://www.fyxer.com' },
    { title: 'Fyxer AI Wellfound profile', url: 'https://wellfound.com/company/fyxer-ai' },
    { title: 'Fyxer AI Crunchbase profile', url: 'https://www.crunchbase.com/organization/fyxer-ai' },
  ],
};
