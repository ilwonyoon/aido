...
export const hippHealth: Company = {
  id: 'hipp-health',
  name: 'Hipp Health',
  description: 'Hipp Health builds AI-native healthcare workflows and clinical productivity tools.',
  website: 'https://wellfound.com/company/hipp-health',
  headquarters: 'San Francisco, CA',
  remote: 'No',

    // Screenshot fallback
    screenshot: '/og-images/hipp-health-screenshot.webp',
  ...
  sources: [
    { title: 'Hipp Health website', url: 'https://wellfound.com/company/hipp-health' },
    { title: 'Hipp Health Wellfound profile', url: 'https://wellfound.com/company/hipp-health' },
    { title: 'Hipp Health Crunchbase profile', url: 'https://www.crunchbase.com/organization/hipp-health' },
  ],
};
