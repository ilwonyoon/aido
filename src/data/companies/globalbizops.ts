...
export const globalbizops: Company = {
  id: 'globalbizops',
  name: 'GlobalBizOps',
  description: 'GlobalBizOps builds AI-powered developer workflows and infrastructure tooling.',
  website: 'https://www.globalbizops.com',
  headquarters: 'Austin, TX',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/globalbizops-og.webp',
  ...
  sources: [
    { title: 'GlobalBizOps website', url: 'https://www.globalbizops.com' },
    { title: 'GlobalBizOps Wellfound profile', url: 'https://wellfound.com/company/globalbizops' },
    { title: 'GlobalBizOps Crunchbase profile', url: 'https://www.crunchbase.com/organization/globalbizops' },
  ],
};
