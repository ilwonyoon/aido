...
export const herostealthModeStartupDisruptingARealWorldSpaceInDireNeedOfAChange: Company = {
  id: 'herostealth-mode-startup-disrupting-a-real-world-space-in-dire-need-of-a-change',
  name: 'HeroStealth mode startup - disrupting a real world space in dire need of a change',
  description: 'HeroStealth mode startup - disrupting a real world space in dire need of a change builds AI-native workflow software for modern teams.',
  website: 'https://gethero.com',
  headquarters: 'San Francisco, CA',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/herostealth-mode-startup-disrupting-a-real-world-space-in-dire-need-of-a-change-og.webp',
  ...
  valuation: 'Private company; valuation figures are not consistently disclosed across public sources.',
  totalFunding: 'Public funding totals vary by source and should be cross-validated in a later pass.',
  ...
  lastUpdated: '2026-02-03T10:37:19',
  sources: [
    { title: 'HeroStealth mode startup - disrupting a real world space in dire need of a change website', url: 'https://gethero.com' },
    { title: 'HeroStealth mode startup - disrupting a real world space in dire need of a change Wellfound profile', url: 'https://wellfound.com/company/herostealth-mode-startup-disrupting-a-real-world-space-in-dire-need-of-a-change' },
    { title: 'HeroStealth mode startup - disrupting a real world space in dire need of a change Crunchbase profile', url: 'https://www.crunchbase.com/organization/herostealth-mode-startup-disrupting-a-real-world-space-in-dire-need-of-a-change' },
  ],
};
