...
export const honeyBadgerLabs: Company = {
  id: 'honey-badger-labs',
  name: 'Honey Badger Labs',
  description: 'Honey Badger Labs builds AI-native workflow software for modern teams.',
  website: 'https://www.honeybadgerlabs.co',
  headquarters: 'Remote',
  remote: 'Yes',

    // OG Image
    ogImage: '/og-images/honey-badger-labs-og.webp',
  ...
  sources: [
    { title: 'Honey Badger Labs website', url: 'https://www.honeybadgerlabs.co' },
    { title: 'Honey Badger Labs Wellfound profile', url: 'https://wellfound.com/company/honey-badger-labs' },
    { title: 'Honey Badger Labs Crunchbase profile', url: 'https://www.crunchbase.com/organization/honey-badger-labs' },
  ],
};
