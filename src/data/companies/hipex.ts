...
export const hipex: Company = {
  id: 'hipex',
  name: 'Hipex',
  description: 'Hipex builds AI-native workflow software for modern teams.',
  website: 'https://hipexapp.com',
  headquarters: 'California',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/hipex-og.webp',
  ...
  sources: [
    { title: 'Hipex website', url: 'https://hipexapp.com' },
    { title: 'Hipex Wellfound profile', url: 'https://wellfound.com/company/hipex' },
    { title: 'Hipex Crunchbase profile', url: 'https://www.crunchbase.com/organization/hipex' },
  ],
};
