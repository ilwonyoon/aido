...
export const gotofit: Company = {
  id: 'gotofit',
  name: 'GoToFit',
  description: 'GoToFit builds AI-native workflow software for modern teams.',
  website: 'https://gotofit.top',
  headquarters: 'San Francisco, CA',
  remote: 'Hybrid',

    // Screenshot fallback
    screenshot: '/og-images/gotofit-screenshot.webp',
  ...
  sources: [
    { title: 'GoToFit website', url: 'https://gotofit.top' },
    { title: 'GoToFit Wellfound profile', url: 'https://wellfound.com/company/gotofit' },
    { title: 'GoToFit Crunchbase profile', url: 'https://www.crunchbase.com/organization/gotofit' },
  ],
};
