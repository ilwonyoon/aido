...
export const finthos: Company = {
  id: 'finthos',
  name: 'Finthos',
  description: 'Finthos builds AI-enabled financial operations and automation workflows.',
  website: 'https://finthos.ai',
  headquarters: 'San Francisco, CA',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/finthos-og.webp',
  ...
  sources: [
    { title: 'Finthos website', url: 'https://finthos.ai' },
    { title: 'Finthos Wellfound profile', url: 'https://wellfound.com/company/finthos' },
    { title: 'Finthos Crunchbase profile', url: 'https://www.crunchbase.com/organization/finthos' },
  ],
};
