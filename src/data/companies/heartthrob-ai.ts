...
export const heartthrobAi: Company = {
  id: 'heartthrob-ai',
  name: 'Heartthrob AI',
  description: 'Heartthrob AI builds AI-native workflow software for modern teams.',
  website: 'https://heartthrob.ai',
  headquarters: 'Remote',
  remote: 'Yes',

    // OG Image
    ogImage: '/og-images/heartthrob-ai-og.webp',
  ...
  sources: [
    { title: 'Heartthrob AI website', url: 'https://heartthrob.ai' },
    { title: 'Heartthrob AI Wellfound profile', url: 'https://wellfound.com/company/heartthrob-ai' },
    { title: 'Heartthrob AI Crunchbase profile', url: 'https://www.crunchbase.com/organization/heartthrob-ai' },
  ],
};
