...
export const fleetworks: Company = {
  id: 'fleetworks',
  name: 'FleetWorks',
  description: 'AI operations platform for fleet productivity, maintenance intelligence, and dispatch automation.',
  website: 'https://fleetworks.ai',
  headquarters: 'San Francisco, CA',
  remote: 'Hybrid',

    // OG Image
    ogImage: '/og-images/fleetworks-og.webp',
  ...
  valuation: 'Private company; valuation is not publicly disclosed.',
  totalFunding: 'Funding visibility is limited across current public sources.',
  ...
  sources: [
    { title: 'FleetWorks website', url: 'https://fleetworks.ai' },
    { title: 'FleetWorks Wellfound profile', url: 'https://wellfound.com/company/fleetworks' },
    { title: 'FleetWorks Crunchbase profile', url: 'https://www.crunchbase.com/organization/fleetworks' },
  ],
};
