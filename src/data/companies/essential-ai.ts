...
export const essentialAi: Company = {
  id: 'essential-ai',
  name: 'Essential AI',
  description: 'Essential AI builds AI-native workflow software for modern teams.',
  website: 'https://essential.ai',
  headquarters: 'San Francisco, CA',
  remote: 'No',

    // OG Image
    ogImage: '/og-images/essential-ai-og.webp',
  ...
  sources: [
    { title: 'Essential AI website', url: 'https://essential.ai' },
    { title: 'Essential AI Wellfound profile', url: 'https://wellfound.com/company/essential-ai' },
    { title: 'Essential AI Crunchbase profile', url: 'https://www.crunchbase.com/organization/essential-ai' },
  ],
};
